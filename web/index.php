...
skilled professionals in the Hospitality industry.</p>
					...
					<div class="section dark parallax nobottommargin" style="padding: 80px 0;background-image: url('images/parallax/hospitalparallex.webp');" data-stellar-background-ratio="0.3">

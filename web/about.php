...
<body class="stretched">
  ...
  <?php include 'header.php';?>
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="    background-image: url(./images/parallax/about.jpg);
    padding: 120px 0px;
    background-position: 50% 29%; padding: 120px 0;" data-stellar-background-ratio="0.3">
		...
		<!-- Content
		============================================= -->
		<section id="content" class="aboutUs">
